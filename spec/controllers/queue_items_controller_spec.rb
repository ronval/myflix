...
describe QueueItemsController do 
  describe "GET index" do 
    ...
    #it "redirects to the sign in page for unauthenticated users" do 
     # get :index
      ...
      ## here above we have the original code that will be replaced with the shared example
    ...
    #We can also do with when the action requires a parameter like this.
  ...
  describe "DELETE destroy"do 
    ...
    it "normalizes the remaining queue after deletion of queue item" do 
      alice = Fabricate(:user)
      set_current_user(alice)
    ...
    it "does not the delete the queue item if the queue item is not in the current users queue" do 
      alice = Fabricate(:user)
      bob = Fabricate(:user)
      set_current_user(alice)
    ...
    it "it redirects to signin page for unauthenticated users" do 
      queue_item = Fabricate(:queue_item)
      delete :destroy, id: queue_item.id
      expect(response).to redirect_to signin_path
    end 
  ...
  context "with unauthenticated user" do 
    it "redirects to the sign in path " do 
      post :update_queue, queue_items: [{id:2, position:3}, {id: 5, postion:2}]
      expect(response).to redirect_to signin_path
    end
  end 
